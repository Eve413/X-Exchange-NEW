...
export const useUserStore = defineStore('user', () => {
 ...
 const getMarkets = async (params: MarketParams) => {
       ...
       const params: AuthParams = {
        ...
        const response = await authApi.authenticated(params);
         ...
         if (response.data.status !== 'error') {
          ...
          const responseNotifPrarams= await authApi.getNotification(notificationParams)
       ...
       const params: AuthParams = {
        ...
        const response = await authApi.authenticated(params);
         ...
         if (response.data.status !== 'error') {
          ...
          const responseBannerarams= await authApi.getCommissions(referalParams)
       ...
       const params: AuthParams = {
        ...
        const response = await authApi.authenticated(params);
         ...
         if (response.data.status !== 'error') {
          ...
          const responseBannerarams= await authApi.getInvitaions(referalParams)
       ...
       const params: AuthParams = {
        ...
        const response = await authApi.authenticated(params);
         ...
         if (response.data.status !== 'error') {
          ...
          const responseBannerarams= await authApi.postWithdraw(withdrawParams)
  ...
  const getDeposit = async (depositParams: DepositParams) => {
    try {
      registerLoading.value = true
       const params: AuthParams = {
          username: usernameAuth,
        ...
        const response = await authApi.authenticated(params);
         ...
         if (response.data.status !== 'error') {
          ...
          const responseBannerarams= await authApi.getDeposit(depositParams)
    ...
    const getStakings = async (stakingsParams: StakingsParams) => {
    try {
      registerLoading.value = true
       const params: AuthParams = {
          username: usernameAuth,
        ...
        const response = await authApi.authenticated(params);
         ...
         if (response.data.status !== 'error') {
          ...
          const responseBannerarams= await authApi.getStakings(stakingsParams)
  ...
  const getStakingsDetil = async (stakingsDetilsParams: StakingsDetilsParams) => {
    try {
      registerLoading.value = true
       const params: AuthParams = {
          username: usernameAuth,
        ...
        const response = await authApi.authenticated(params);
         ...
         if (response.data.status !== 'error') {
          ...
          const responseBannerarams= await authApi.getStakingsDetil(stakingsDetilsParams)
   ...
   const postStakingsSubscriptionParams = async (stakingsSubscriptionParams: StakingsSubscriptionParams) => {
    try {
      registerLoading.value = true
       const params: AuthParams = {
          username: usernameAuth,
        ...
        const response = await authApi.authenticated(params);
         ...
         if (response.data.status !== 'error') {
          ...
          const responseBannerarams= await authApi.postStakingsSubscriptionParams(stakingsSubscriptionParams)
 ...
 const getAirdrops = async (airdropsParams: AirdropsParams) => {
    try {
      registerLoading.value = true
       const params: AuthParams = {
          username: usernameAuth,
        ...
        const response = await authApi.authenticated(params);
         ...
         if (response.data.status !== 'error') {
          ...
          const responseBannerarams= await authApi.getAirdrops(airdropsParams)
  ...
  const getAirdropsDetil = async (airdropsParams: AirdropsDetilsParams) => {
    try {
      registerLoading.value = true
       const params: AuthParams = {
          username: usernameAuth,
        ...
        const response = await authApi.authenticated(params);
         ...
         if (response.data.status !== 'error') {
          ...
          const responseBannerarams= await authApi.getAirdropsDetil(airdropsParams)
   ...
   const postAirdropsSubscription = async (airdropsSubscriptionParams: AirdropsSubscriptionParams) => {
    try {
      registerLoading.value = true
       const params: AuthParams = {
          username: usernameAuth,
        ...
        const response = await authApi.authenticated(params);
         ...
         if (response.data.status !== 'error') {
          ...
          const responseBannerarams= await authApi.postAirdropsSubscription(airdropsSubscriptionParams)
   ...
   const postAirdropsSubscriptionDetil = async (airdropsSubscriptionDetilParams: AirdropsSubscriptionDetilParams) => {
    try {
      registerLoading.value = true
       const params: AuthParams = {
          username: usernameAuth,
        ...
        const response = await authApi.authenticated(params);
         ...
         if (response.data.status !== 'error') {
          ...
          const responseBannerarams= await authApi.postAirdropsSubscriptionDetil(airdropsSubscriptionDetilParams)
   ...
   const getEvent = async (eventParams: EventParams) => {
    try {
      registerLoading.value = true
       const params: AuthParams = {
          username: usernameAuth,
        ...
        const response = await authApi.authenticated(params);
         ...
         if (response.data.status !== 'error') {
          ...
          const responseBannerarams= await authApi.getEvents(eventParams)
       ...
       const params: AuthParams = {
        ...
        const response = await authApi.authenticated(params);
         ...
         if (response.data.status !== 'error') {
          ...
          const responseBannerarams= await authApi.getSubscriptions(airdropsParams)
  ...
  const init = () => {
   ...
   const getBannerTrading = async () => {
    try {
      const response = await userApi.getBanners()
  ...
  return {
    ...
    getStakings,
    getStakingsDetil,
    postStakingsSubscriptionParams,
    getAirdrops,
    getAirdropsDetil,
    postAirdropsSubscription,
