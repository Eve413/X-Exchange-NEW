<template>
	...
	<view class="market-container">
					...
					<view class="trader-card">
						<view class="trader-info">
							...
							<view class="trader-details">
								...
								<view class="trader-rank">
									<image class="humanIcon" src="/static/icons/humanIcon.png" mode="aspectFit" />
									<text class="rankTitle">{{ traderPerformanceDetail?.followers ?? 0 }}</text>
									<text class="rankTitle">/{{ traderPerformanceDetail?.maxFollowers ?? 0 }}</text>
								</view>
							</view>
						...
						<view class="follow-amount-section">
							...
							<view class="amount-dropdown">
								<view class="dropdown-header" @click="toggleDropdown = !toggleDropdown">
									...
									<image class="dropdown-arrow" :class="{ rotate: toggleDropdown }"
										src="/static/icons/arrow-bottom.png" mode="aspectFit" />
								</view>
								...
								<view class="dropdown-options" v-if="toggleDropdown">
									<view v-for="amount in amountOptions" :key="amount" class="dropdown-option"
										...
										<image class="check-mark" v-if="selectedAmount === amount"
											src="/static/icons/checkIcon.png" mode="aspectFit" />
									</view>
		...
		<!-- Bottom Navigation -->
		<BottomTabBar currentPath="/pages/discover/index" @change="handleTabChange" />
	</view>
</template>
...
// Define props to prevent warning about extraneous attributes
defineProps<{
	traderId?: string;
	type?: string;
}>();
