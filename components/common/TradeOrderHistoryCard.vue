<template>
  <view class="order-card">
    <!-- Header -->
    <view class="header">
      <text class="order">{{ t('trade-page.trade-history-card.one') }}：{{ orderId }}</text>
      ...
      <view class="info">
        <view class="row">
          ...
          <view class="column-right">
            ...
            <view class="right">
              <text class="value">{{ pnl }} USDT</text>
            </view>
          </view>
    ...
    <view class="info-section">
      <view class="info-item">
        <text class="label">{{ t('trade-page.trade-history-card.two') }}</text>
      ...
      <view class="info-item">
        <text class="label">{{ t('trade-page.trade-history-card.three') }}</text>
        <view class="value editable">
          <text>{{ quantity }}</text>
      ...
      <view class="info-item">
        <text class="label">{{ t('trade-page.trade-history-card.four') }}</text>
        <view class="value editable">
          <text>{{ amount }}</text>
      ...
      <view class="info-item">
        <text class="label">{{ t('trade-page.trade-history-card.five') }}</text>
        <view class="value editable">
          <text>{{ fee }}</text>
...
.btn-cancel {
  ...
  font-size: 28rpx;
  flex: 1 1 0;
  /* make cancel button take equal width as info blocks */
  text-align: center;
}
</style>
